...
export const regions: Region[] = [
  {
    ...
    description: {
      ...
      zh: "探索古老的寺庙、翠绿的梯田、世界级的冲浪胜地和充满活力的夜生活。巴厘岛完美融合了文化、冒险和休闲。",
    },
    image: "/assets/bali",
    province: "Bali",
  ...
  },
  {
    ...
    description: {
      ...
      zh: "发现原始海滩、雄伟的林贾尼火山和吉利群岛的清澈海水。龙目岛是巴厘岛更安静、更原始的邻居。",
    },
    image: "/assets/lombok",
  ...
  },
  {
    ...
    description: {
      ...
      zh: "与传说中的科莫多巨蜥同行，潜入世界上生物多样性最丰富的水域，航行穿越令人叹为观止的岛屿景观。",
    },
    image: "/assets/komodo",
  ...
  },
  {
    ...
    description: {
      ...
      zh: "体验原始未开发的美景——壮观的悬崖、碧绿的泻湖、古老的巨石村庄和标志性的尼希瓦图海滩。",
    },
    image: "/assets/sumba",
    province: "Nusa Tenggara Timur",
    popularFor: [
  ...
  },
  {
    ...
    description: {
      ...
      zh: "伊真火山的空灵蓝色火焰、布罗莫火山广阔的沙海和壮丽的通帕瑟武瀑布的家园。东爪哇是冒险家的梦想。",
    },
  ...
  },
  {
    ...
    description: {
      ...
      zh: "漫步万隆的起伏茶园，惊叹于白火山口的超凡景象，探索巽他文化的心脏地带。",
    },
  ...
  },
  {
    ...
    description: {
      ...
      zh: "在古老的婆罗浮屠和普兰巴南寺庙前驻足感叹，探索文化之都日惹，见证数百年的爪哇传统。",
    },
  ...
  },
  {
    ...
    description: {
      ...
      zh: "在拉基峰冲击世界级浪潮，探索莫约岛的偏远之美，徒步穿越茂密森林到达隐藏的瀑布。松巴哇是原始的冒险。",
    },
