...
function p(
  ...
  slug: string,
  regionId: string,
  name: {en: string; id: string; zh: string},
  desc: {en: string; id: string; zh: string},
  longDesc: {en: string; id: string; zh: string},
...
const baliPlaces: Place[] = [
  p(
    ...
    {en: "Ubud", id: "Ubud", zh: "乌布"},
    {
      ...
      zh: "巴厘岛的文化中心——翠绿的梯田、神圣的猴林和世界级的艺术画廊。",
    },
    {
      ...
      zh: "乌布坐落在巴厘岛中部翠绿的高地上，长期以来被视为这座岛屿的文化和精神中心。古老的寺庙与层层叠叠的梯田相映成趣。",
    },
    "culture",
    "Full day",
  ),
  p(
    ...
    "nusa-penida",
    "region-bali",
    {en: "Nusa Penida", id: "Nusa Penida", zh: "努沙佩尼达"},
    {
      ...
      zh: "巴厘岛海岸外的崎岖岛屿，有令人叹为观止的悬崖、碧绿的海湾和原始的潜水点。",
    },
    {
      ...
      zh: "从巴厘岛大陆乘坐45分钟快艇即可到达，努沙佩尼达感觉像是一个完全不同的世界。",
    },
    "beach",
    "Full day",
  ),
  p(
    ...
    "nusa-lembongan",
    "region-bali",
    {en: "Nusa Lembongan", id: "Nusa Lembongan", zh: "蓝梦岛"},
    {
      ...
      zh: "宁静的岛屿天堂，拥有清澈的海水、红树林和适合浮潜的多彩珊瑚礁。",
    },
    {
      ...
      zh: "蓝梦岛是巴厘岛东南部的一个小岛，提供远离喧嚣的宁静逃离。",
    },
    "beach",
    "Full day",
  ),
  p(
    ...
    "mount-batur",
    "region-bali",
    {en: "Mount Batur", id: "Gunung Batur", zh: "巴图尔火山"},
    {
    ...
    },
    {
      ...
      zh: "巴图尔火山海拔1717米，是巴厘岛最容易到达的活火山之一。",
    },
    "mountain",
    "Full day",
  ),
  p(
    ...
    "jimbaran",
    "region-bali",
    {en: "Jimbaran", id: "Jimbaran", zh: "金巴兰"},
    {
    ...
    },
    {
      ...
      zh: "金巴兰湾是巴厘岛首屈一指的海滨海鲜目的地。日落时分，数十家海鲜餐厅在沙滩上摆放烛光餐桌。",
    },
    "beach",
    "Half day",
  ),
  p(
    ...
    "nusa-dua",
    "region-bali",
    {en: "Nusa Dua", id: "Nusa Dua", zh: "努沙杜瓦"},
    {
      ...
      zh: "巴厘岛的豪华度假胜地，拥有原始海滩、水上运动和世界级酒店。",
    },
    {
      ...
      zh: "努沙杜瓦是巴厘岛的豪华度假区，拥有平静的碧绿海水，非常适合游泳和水上运动。",
    },
    "beach",
    "Half day",
  ),
  p(
    ...
    "tanah-lot-temple",
    "region-bali",
    {en: "Tanah Lot Temple", id: "Pura Tanah Lot", zh: "海神庙"},
    {
    ...
    },
    {
      ...
      zh: "海神庙是巴厘岛最重要的印度教寺庙之一，建于16世纪的海上岩石之上。",
    },
    "temple",
    "Half day",
  ),
  p(
    ...
    "melasti-beach",
    "region-bali",
    {en: "Melasti Beach", id: "Pantai Melasti", zh: "梅拉斯提海滩"},
    {
      ...
      zh: "南巴厘岛隐藏的迷人海滩，有高耸的石灰岩悬崖、碧绿海水和白色沙滩。",
    },
    {
  ...
  p(
    ...
    "balangan-beach",
    "region-bali",
    {en: "Balangan Beach", id: "Pantai Balangan", zh: "巴兰安海滩"},
    {
      ...
      zh: "冲浪者天堂，金色沙滩、稳定的浪花和布基特半岛的壮观悬崖景色。",
    },
    {
      ...
      zh: "巴兰安海滩是一个美丽的金色沙滩，藏在布基特半岛的悬崖下方。",
    },
    "beach",
    "Half day",
  ),
  p(
    ...
    "seminyak",
    "region-bali",
    {en: "Seminyak", id: "Seminyak", zh: "水明漾"},
    {
      ...
      zh: "巴厘岛时尚海滨中心——高端海滩俱乐部、设计师精品店、世界级餐饮和传奇日落。",
    },
    {
  ...
  p(
    ...
    {en: "Uluwatu", id: "Uluwatu", zh: "乌鲁瓦图"},
    {
      ...
      zh: "坐落在印度洋上方悬崖的壮观寺庙，以日落克差克舞和冲浪闻名。",
    },
    {
      ...
      zh: "坐落在印度洋上方70米高的壮观悬崖上，乌鲁瓦图海神庙是巴厘岛最具标志性的海上寺庙之一。",
    },
    "temple",
    "Half day",
  ),
  p(
    ...
    {en: "Sanur", id: "Sanur", zh: "沙努尔"},
    {
      ...
      zh: "悠闲的海滨小镇，拥有平静的海水、美丽的海滨步道和传统渔村魅力。",
    },
    {
      ...
      zh: "沙努尔是巴厘岛最早的海滩度假区，提供更轻松的家庭友好氛围。",
    },
    "beach",
    "Half day",
  ),
  p(
    ...
    },
    {
      ...
      zh: "德格拉朗梯田是巴厘岛最具标志性的景观之一，展示了传统的苏巴克灌溉系统。",
    },
    "nature",
    "Half day",
  ),
  p(
    ...
    {en: "Kuta", id: "Kuta", zh: "库塔"},
    {
      ...
      zh: "巴厘岛最著名的海滩小镇——充满活力的夜生活、适合初学者的冲浪和无尽的娱乐。",
    },
    {
      ...
      zh: "库塔是巴厘岛旅游故事的起点。这个繁华的海滩小镇提供绵长的金色沙滩和温柔的海浪。",
    },
    "beach",
    "Half day",
  ),
  p(
    ...
    {en: "Canggu", id: "Canggu", zh: "仓古"},
    {
      ...
      zh: "巴厘岛的潮流天堂——冲浪文化、时尚咖啡馆、联合办公空间和世界级海滩俱乐部。",
    },
    {
      ...
      zh: "仓古已成为巴厘岛最酷的海滨村庄，吸引着来自世界各地的数字游民和冲浪者。",
    },
    "beach",
    "Half day",
  ),
...
const lombokPlaces: Place[] = [
  p(
    ...
    "gili-trawangan",
    "region-lombok",
    {en: "Gili Trawangan", id: "Gili Trawangan", zh: "吉利特拉旺安"},
    {
      ...
      zh: "吉利群岛中最大最热闹的岛屿——没有机动车辆、美丽的珊瑚礁和传奇的夜生活。",
    },
    {
      ...
      zh: "吉利特拉旺安被誉为吉利群岛的派对岛，提供独特的无车体验。",
    },
    "beach",
    "2 days",
  ),
  p(
    ...
    "gili-meno",
    "region-lombok",
    {en: "Gili Meno", id: "Gili Meno", zh: "吉利美诺"},
    {
      ...
      zh: "三个吉利岛中最宁静的——蜜月旅行者的完美选择，拥有原始海滩和水下雕塑。",
    },
    {
      ...
      zh: "吉利美诺是三个吉利岛中最小最安静的，是浪漫度假的理想之地。",
    },
    "beach",
    "Full day",
  ),
  p(
    ...
    "gili-air",
    "region-lombok",
    {en: "Gili Air", id: "Gili Air", zh: "吉利艾尔"},
    {
      ...
      zh: "特拉旺安的活力与美诺的宁静之间的完美平衡——轻松的氛围和出色的浮潜。",
    },
    {
  ...
  p(
    ...
    "mandalika",
    "region-lombok",
    {en: "Mandalika", id: "Mandalika", zh: "曼达利卡"},
    {
    ...
    },
    {
      ...
      zh: "曼达利卡是印度尼西亚新兴的高端目的地，拥有MotoGP赛道。",
    },
    "beach",
    "Full day",
  ),
  p(
    ...
    "kuta-lombok",
    "region-lombok",
    {en: "Kuta Lombok", id: "Kuta Lombok", zh: "库塔龙目"},
    {
      ...
      zh: "不要与巴厘岛的库塔混淆——一个悠闲的冲浪小镇，拥有碧绿的海湾。",
    },
    {
  ...
  p(
    ...
    "sembalun",
    "region-lombok",
    {en: "Sembalun", id: "Sembalun", zh: "森巴伦"},
    {
      ...
      zh: "林贾尼火山脚下的高地山谷——著名徒步旅行的起点，有草莓农场和草原。",
    },
    {
  ...
  p(
    ...
    "mount-rinjani",
    "region-lombok",
    {en: "Mount Rinjani", id: "Gunung Rinjani", zh: "林贾尼火山"},
    {
      ...
      zh: "印度尼西亚第二高火山，拥有令人叹为观止的火山口湖——必去的多日徒步旅行。",
    },
    {
      ...
      zh: "林贾尼火山海拔3726米，是印度尼西亚最值得的徒步目的地之一。",
    },
    "mountain",
    "3 days",
  ),
  p(
    ...
    "senggigi",
    "region-lombok",
    {en: "Senggigi", id: "Senggigi", zh: "圣吉吉"},
    {
      ...
      zh: "龙目岛的主要旅游区，有海滩度假村、海鲜餐厅和壮丽的日落景色。",
    },
    {
  ...
  p(
    ...
    "pink-beach-lombok",
    "region-lombok",
    {en: "Pink Beach Lombok", id: "Pantai Pink Lombok", zh: "龙目岛粉红沙滩"},
    {
      ...
      zh: "世界上罕见的粉红沙滩——珊瑚碎片与白沙混合形成粉红色海岸线。",
    },
    {
      ...
      zh: "龙目岛东海岸的粉红沙滩是世界上为数不多的粉红色沙滩之一。",
    },
    "beach",
    "Full day",
  ),
  p(
    ...
    "tanjung-aan",
    "region-lombok",
    {en: "Tanjung Aan", id: "Tanjung Aan", zh: "丹绒安"},
    {
  ...
  p(
    ...
    "selong-belanak",
    "region-lombok",
    {en: "Selong Belanak", id: "Selong Belanak", zh: "塞隆贝拉纳克"},
    {
      ...
      zh: "月牙形海滩，温柔的海浪适合初学冲浪者，还有令人惊叹的山坡全景。",
    },
    {
      ...
      zh: "塞隆贝拉纳克是龙目岛最美丽的海滩之一，月牙形的白色细沙海滩。",
    },
    "beach",
    "Half day",
  ),
  p(
    ...
    "merese-hill",
    "region-lombok",
    {en: "Merese Hill", id: "Bukit Merese", zh: "梅雷斯山"},
    {
    ...
    },
    {
      ...
      zh: "梅雷斯山是一座草地覆盖的山顶，俯瞰丹绒安湾和浩瀚的印度洋。",
    },
    "nature",
    "Half day",
  ),
  p(
    ...
    },
    {
      ...
      zh: "贝南斯托克尔是一座壮丽的多层瀑布，隐藏在林贾尼火山山坡的热带森林中。",
    },
    "waterfall",
    "Half day",
  ),
  p(
    ...
    },
    {
      ...
      zh: "森当吉莱瀑布从31米高处倾泻而下，流入林贾尼火山脚下的水池。",
    },
    "waterfall",
    "Half day",
  ),
  p(
    ...
    "pusuk-monkey-forest",
    "region-lombok",
    {en: "Pusuk Monkey Forest", id: "Hutan Monyet Pusuk", zh: "普苏克猴林"},
    {
    ...
    },
    {
      ...
      zh: "普苏克猴林是龙目岛北部高地一段风景优美的山路，穿过茂密的热带森林。",
    },
    "nature",
    "Half day",
  ),
  p(
    ...
    "gili-nanggu",
    "region-lombok",
    {en: "Gili Nanggu", id: "Gili Nanggu", zh: "吉利南古"},
    {
  ...
  p(
    ...
    "sade-village",
    "region-lombok",
    {en: "Sade Village", id: "Desa Sade", zh: "萨德村"},
    {
      ...
      zh: "古老的萨萨克村庄，保留着传统茅草屋顶房屋和数百年的编织传统。",
    },
    {
  ...
  p(
    ...
    "batu-payung",
    "region-lombok",
    {en: "Batu Payung", id: "Batu Payung", zh: "伞石"},
    {
    ...
    },
    {
      ...
      zh: "伞石是一块独特的天然岩石，形似巨大的雨伞，矗立在丹绒安附近的碧绿海水中。",
    },
    "nature",
    "Half day",
  ),
  p(
    ...
    "mawun-beach",
    "region-lombok",
    {en: "Mawun Beach", id: "Pantai Mawun", zh: "马翁海滩"},
    {
    ...
    },
    {
      ...
      zh: "马翁海滩是一个令人惊叹的马蹄形海湾，两侧被郁郁葱葱的绿色山丘环绕。",
    },
    "beach",
    "Half day",
  ),
  p(
    ...
    "gili-gede",
    "region-lombok",
    {en: "Gili Gede", id: "Gili Gede", zh: "吉利格德"},
    {
      ...
      zh: "龙目岛西南部的和平岛屿，提供真实的村庄生活和人少的海滩。",
    },
    {
      ...
      zh: "吉利格德是西南吉利群岛中最大的岛屿，提供远离游客人群的真实岛屿体验。",
    },
    "beach",
    "Full day",
  ),
...
const komodoPlaces: Place[] = [
  p(
    ...
    "labuan-bajo",
    "region-komodo",
    {en: "Labuan Bajo", id: "Labuan Bajo", zh: "拉布安巴焦"},
    {
    ...
    },
    {
      ...
      zh: "拉布安巴焦是弗洛勒斯岛西端的繁华渔镇，是科莫多国家公园的主要门户。",
    },
    "nature",
    "Half day",
  ),
  p(
    ...
    "padar-island",
    "region-komodo",
    {en: "Padar Island", id: "Pulau Padar", zh: "帕达尔岛"},
    {
      ...
      zh: "以其壮观的三湾景观闻名——登上山顶欣赏印尼最标志性的全景之一。",
    },
    {
  ...
  p(
    ...
    "komodo-island",
    "region-komodo",
    {en: "Komodo Island", id: "Pulau Komodo", zh: "科莫多岛"},
    {
      ...
      zh: "传说中科莫多巨蜥的家园——世界上最大的现存蜥蜴在其自然栖息地。",
    },
    {
      ...
      zh: "科莫多岛是科莫多国家公园的同名岛屿，您可以在此观察世界上最大的蜥蜴。",
    },
    "adventure",
    "Full day",
  ),
  p(
    ...
    "pink-beach-komodo",
    "region-komodo",
    {en: "Pink Beach Komodo", id: "Pantai Pink Komodo", zh: "科莫多粉红沙滩"},
    {
    ...
    },
    {
      ...
      zh: "科莫多国家公园的粉红沙滩是世界上仅有的七个粉红沙滩之一。",
    },
    "beach",
    "Half day",
  ),
  p(
    ...
    "manta-point",
    "region-komodo",
    {en: "Manta Point", id: "Manta Point", zh: "蝠鲼观赏点"},
    {
  ...
  p(
    ...
    "rinca-island",
    "region-komodo",
    {en: "Rinca Island", id: "Pulau Rinca", zh: "林卡岛"},
    {
    ...
    },
    {
      ...
      zh: "林卡岛比科莫多岛更靠近拉布安巴焦，是观赏科莫多龙的热门选择。",
    },
    "adventure",
    "Half day",
  ),
  p(
    ...
    "kelor-island",
    "region-komodo",
    {en: "Kelor Island", id: "Pulau Kelor", zh: "克洛尔岛"},
    {
      ...
      zh: "一座小岛，短暂的山顶徒步可欣赏360度全景和附近出色的浮潜。",
    },
    {
  ...
  p(
    ...
    "taka-makassar",
    "region-komodo",
    {en: "Taka Makassar", id: "Taka Makassar", zh: "塔卡望加锡"},
    {
  ...
  p(
    ...
    "kanawa-island",
    "region-komodo",
    {en: "Kanawa Island", id: "Pulau Kanawa", zh: "卡纳瓦岛"},
    {
      ...
      zh: "小型私人度假岛屿，可直接从海滩浮潜，拥有美丽的珊瑚花园。",
    },
    {
      ...
      zh: "卡纳瓦岛是一个小型私人管理的岛屿，原始的珊瑚礁可直接从海滩到达。",
    },
    "beach",
    "Full day",
  ),
  p(
    ...
    "kalong-island",
    "region-komodo",
    {en: "Kalong Island", id: "Pulau Kalong", zh: "蝙蝠岛"},
    {
    ...
    },
    {
      ...
      zh: "蝙蝠岛以数千只大型飞狐（果蝠）在日落时从红树林飞出觅食的壮观景象而闻名。",
    },
    "nature",
    "Half day",
  ),
...
const sumbaPlaces: Place[] = [
  p(
    ...
    "nihiwatu-beach",
    "region-sumba",
    {en: "Nihiwatu Beach", id: "Pantai Nihiwatu", zh: "尼希瓦图海滩"},
    {
      ...
      zh: "世界著名的豪华冲浪胜地，一直被评为世界最佳酒店海滩之一。",
    },
    {
      ...
      zh: "尼希瓦图海滩位于松巴岛西海岸，曾被评为世界第一酒店海滩。",
    },
    "beach",
    "Full day",
  ),
  p(
    ...
    "weekuri-lagoon",
    "region-sumba",
    {en: "Weekuri Lagoon", id: "Laguna Weekuri", zh: "维库里泻湖"},
    {
      ...
      zh: "令人惊叹的咸水泻湖，清澈的碧绿海水，适合游泳和悬崖跳水。",
    },
    {
  ...
  p(
    ...
    "ratenggaro-village",
    "region-sumba",
    {en: "Ratenggaro Village", id: "Kampung Ratenggaro", zh: "拉滕加罗村"},
    {
    ...
    },
    {
      ...
      zh: "拉滕加罗是松巴岛最具标志性的传统村庄之一，矗立在俯瞰大海的悬崖上。",
    },
    "village",
    "Half day",
  ),
  p(
    ...
    "wairinding-hill",
    "region-sumba",
    {en: "Wairinding Hill", id: "Bukit Wairinding", zh: "瓦伊林丁山"},
    {
    ...
    },
    {
      ...
      zh: "瓦伊林丁山提供松巴岛最常被拍照的景观——无尽起伏的草原山丘在日落时变成金色。",
    },
    "nature",
    "Half day",
  ),
  p(
    ...
    "lapopu-waterfall",
    "region-sumba",
    {en: "Lapopu Waterfall", id: "Air Terjun Lapopu", zh: "拉波普瀑布"},
    {
    ...
    },
    {
      ...
      zh: "拉波普瀑布是松巴岛最高的瀑布，约80米高，穿过茂密的热带森林。",
    },
    "waterfall",
    "Half day",
  ),
  p(
    ...
    "walakiri-beach",
    "region-sumba",
    {en: "Walakiri Beach", id: "Pantai Walakiri", zh: "瓦拉基里海滩"},
    {
    ...
    },
    {
      ...
      zh: "瓦拉基里海滩以其独特的一排红树林而闻名，在金色和深红色的日落中形成迷人的剪影。",
    },
    "beach",
    "Half day",
  ),
  p(
    ...
    "mandorak-beach",
    "region-sumba",
    {en: "Mandorak Beach", id: "Pantai Mandorak", zh: "曼多拉克海滩"},
    {
    ...
    },
    {
      ...
      zh: "曼多拉克海滩是松巴岛西海岸藏在壮丽石灰岩悬崖之间的僻静天堂。",
    },
    "beach",
    "Half day",
  ),
  p(
    ...
    "tanggedu-waterfall",
    "region-sumba",
    {en: "Tanggedu Waterfall", id: "Air Terjun Tanggedu", zh: "唐格杜瀑布"},
    {
      ...
      zh: "独特的峡谷瀑布，水流穿过狭窄的石灰岩峡谷流入碧绿的水池。",
    },
    {
      ...
      zh: "唐格杜瀑布是松巴岛最独特的自然奇观之一——水流穿过一系列狭窄的石灰岩峡谷壁流入阶梯状的碧绿水池。",
    },
    "waterfall",
    "Half day",
  ),
  p(
    ...
    "praijing-village",
    "region-sumba",
    {en: "Praijing Village", id: "Kampung Praijing", zh: "普拉京村"},
    {
    ...
    },
    {
      ...
      zh: "普拉京村是松巴岛最容易到达的传统村庄之一，拥有成排的高耸尖顶祖先房屋。",
    },
    "village",
    "Half day",
  ),
  p(
    ...
    "bwanna-beach",
    "region-sumba",
    {en: "Bwanna Beach", id: "Pantai Bwanna", zh: "布瓦纳海滩"},
    {
    ...
    },
    {
      ...
      zh: "布瓦纳海滩是松巴岛的隐藏宝藏之一——绵长的原始白色沙滩，几乎无人打扰。",
    },
    "beach",
    "Half day",
  ),
...
const sumbawaPlaces: Place[] = [
  p(
    ...
    "moyo-island",
    "region-sumbawa",
    {en: "Moyo Island", id: "Pulau Moyo", zh: "莫约岛"},
    {
    ...
    },
    {
      ...
      zh: "莫约岛是松巴哇北海岸外的自然保护区，以原始珊瑚礁和瀑布闻名。",
    },
    "nature",
    "2 days",
  ),
  p(
    ...
    "maluk-beach",
    "region-sumbawa",
    {en: "Maluk Beach", id: "Pantai Maluk", zh: "马卢克海滩"},
    {
      ...
      zh: "松巴哇西南部美丽的月牙形海滩，浪花稳定，深受冲浪者欢迎。",
    },
    {
  ...
  p(
    ...
    "saleh-bay",
    "region-sumbawa",
    {en: "Saleh Bay", id: "Teluk Saleh", zh: "萨莱湾"},
    {
  ...
  p(
    ...
    "kenawa-island",
    "region-sumbawa",
    {en: "Kenawa Island", id: "Pulau Kenawa", zh: "克纳瓦岛"},
    {
  ...
  p(
    ...
    "lakey-peak",
    "region-sumbawa",
    {en: "Lakey Peak", id: "Lakey Peak", zh: "拉基峰"},
    {
  ...
  p(
    ...
    "satonda-island",
    "region-sumbawa",
    {en: "Satonda Island", id: "Pulau Satonda", zh: "萨通达岛"},
    {
      ...
      zh: "一座火山岛，拥有独特的咸水火山口湖，周围环绕着原始珊瑚礁。",
    },
    {
  ...
  p(
    ...
    "mantar-hill",
    "region-sumbawa",
    {en: "Mantar Hill", id: "Bukit Mantar", zh: "曼塔尔山"},
    {
    ...
    },
    {
      ...
      zh: "曼塔尔山是松巴哇最令人叹为观止的观景点之一，可以欣赏云海上的壮丽日出。",
    },
    "nature",
    "Half day",
  ),
  p(
    ...
    "sumbawa-besar",
    "region-sumbawa",
    {en: "Sumbawa Besar", id: "Sumbawa Besar", zh: "大松巴哇"},
    {
      ...
      zh: "岛上的主要城镇，拥有历史悠久的苏丹宫殿，是通往松巴哇自然景点的门户。",
    },
    {
      ...
      zh: "大松巴哇是松巴哇的主要城镇和文化中心，拥有历史悠久的苏丹宫殿。",
    },
    "culture",
    "Half day",
  ),
...
const eastJavaPlaces: Place[] = [
  p(
    ...
    "mount-bromo",
    "region-east-java",
    {en: "Mount Bromo", id: "Gunung Bromo", zh: "布罗莫火山"},
    {
      ...
      zh: "印度尼西亚最标志性的火山——活火山口坐落在广阔的腾格尔破火山口沙海中。",
    },
    {
  ...
  p(
    ...
    "ijen-crater",
    "region-east-java",
    {en: "Ijen Crater", id: "Kawah Ijen", zh: "伊真火山口"},
    {
    ...
    },
    {
      ...
      zh: "伊真火山口以两种自然现象而闻名：黎明前黑暗中可见的蓝色火焰和世界上最大的酸性火山口湖。",
    },
    "mountain",
    "Full day",
  ),
  p(
    ...
    },
    {
      ...
      zh: "令人叹为观止的120米帘状瀑布，常被称为'印度尼西亚的尼亚加拉'。",
    },
    {
      ...
      zh: "通帕瑟武瀑布是一座壮丽的120米瀑布，像巨大的帘幕般展开。",
    },
    "waterfall",
    "Full day",
  ),
  ...
  p(
    ...
    {en: "Malang", id: "Malang", zh: "玛琅"},
    {
      ...
      zh: "迷人的高地城市，拥有荷兰殖民建筑、丰富的美食和通往东爪哇自然景观的门户。",
    },
    {
      ...
      zh: "玛琅是东爪哇一个迷人的高地城市，以其凉爽的气候和荷兰殖民遗产建筑闻名。",
    },
    "culture",
    "Full day",
  ),
...
const westJavaPlaces: Place[] = [
  p(
    ...
    {en: "Bandung", id: "Bandung", zh: "万隆"},
    {
      ...
      zh: "印度尼西亚的创意之都——以茶园、工厂直销店和充满活力的咖啡文化闻名的高地城市。",
    },
    {
      ...
      zh: "万隆是西爪哇省会和印度尼西亚第三大城市，被称为'爪哇的巴黎'。",
    },
    "culture",
    "Full day",
  ),
  p(
    ...
    "kawah-putih",
    "region-west-java",
    {en: "Kawah Putih", id: "Kawah Putih", zh: "白火山口"},
    {
    ...
    },
    {
      ...
      zh: "白火山口是万隆南部海拔2430米的火山口湖，湖水颜色随硫磺含量而变化。",
    },
    "nature",
    "Half day",
  ),
  p(
    ...
    "tangkuban-perahu",
    "region-west-java",
    {en: "Tangkuban Perahu", id: "Tangkuban Perahu", zh: "覆舟火山"},
    {
    ...
    },
    {
      ...
      zh: "覆舟火山是为数不多的可以直接开车到火山口边缘的火山之一。",
    },
    "mountain",
    "Half day",
  ),
  p(
    ...
    "situ-patenggang",
    "region-west-java",
    {en: "Situ Patenggang", id: "Situ Patenggang", zh: "帕腾甘湖"},
    {
    ...
    },
    {
      ...
      zh: "帕腾甘湖是万隆附近海拔1600米的风景如画的湖泊，被起伏的茶园环绕。",
    },
    "nature",
    "Half day",
  ),
  p(
    ...
    {en: "Puncak", id: "Puncak", zh: "本查克"},
    {
      ...
      zh: "雅加达和万隆之间受欢迎的高地度假地，拥有茶园和凉爽的山间空气。",
    },
    {
  ...
  p(
    ...
    "pangandaran",
    "region-west-java",
    {en: "Pangandaran", id: "Pangandaran", zh: "庞岸达兰"},
    {
      ...
      zh: "西爪哇首屈一指的海滩目的地，拥有独特的半岛、自然保护区和壮丽的绿色峡谷。",
    },
    {
      ...
      zh: "庞岸达兰是西爪哇最受欢迎的海滩目的地，拥有独特的半岛和壮观的绿色峡谷。",
    },
    "beach",
    "Full day",
  ),
...
const centralJavaPlaces: Place[] = [
  p(
    ...
    "borobudur-temple",
    "region-central-java",
    {en: "Borobudur Temple", id: "Candi Borobudur", zh: "婆罗浮屠"},
    {
      ...
      zh: "世界上最大的佛教寺庙——9世纪的联合国教科文组织杰作，有2672块浮雕和504尊佛像。",
    },
    {
      ...
      zh: "婆罗浮屠是世界上最大的佛教寺庙，也是印度尼西亚最受欢迎的旅游景点。",
    },
    "temple",
    "Full day",
  ),
  p(
    ...
    "prambanan-temple",
    "region-central-java",
    {en: "Prambanan Temple", id: "Candi Prambanan", zh: "普兰巴南"},
    {
      ...
      zh: "印度尼西亚最大的印度教寺庙群——联合国教科文组织世界遗产，拥有高耸的石塔。",
    },
    {
      ...
      zh: "普兰巴南是9世纪的印度教寺庙群，供奉三大神——梵天、毗湿奴和湿婆。",
    },
    "temple",
    "Full day",
  ),
  p(
    ...
    "dieng-plateau",
    "region-central-java",
    {en: "Dieng Plateau", id: "Dataran Tinggi Dieng", zh: "迪恩高原"},
    {
      ...
      zh: "海拔2000米的多雾火山高原，拥有古老的印度教寺庙、多彩的火山口湖和日出景色。",
    },
    {
      ...
      zh: "迪恩高原是中爪哇海拔2000米的偏远火山高地，经常被薄雾笼罩。",
    },
    "nature",
    "Full day",
  ),
  p(
    ...
    },
    {
      ...
      zh: "由27个岛屿组成的热带海洋天堂，拥有原始珊瑚礁、红树林和白色沙滩。",
    },
    {
      ...
      zh: "卡里穆爪哇是爪哇海中由27个岛屿组成的群岛，是国家海洋公园的一部分。",
    },
    "beach",
    "3 days",
  ),
